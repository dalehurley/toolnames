...
import { Download, Copy, Check, Smartphone, Globe } from "lucide-react";
    ...
    <Card className="w-full max-w-4xl mx-auto">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="bg-muted rounded-lg p-3 text-sm text-muted-foreground">
          <strong>PWA APIs</strong> — Generates <code>manifest.json</code> (Web App Manifest), Service Worker (Cache API + Background Sync), and HTML meta tags for a production-ready PWA.
        </div>
      </CardContent>
    </Card>
  );
